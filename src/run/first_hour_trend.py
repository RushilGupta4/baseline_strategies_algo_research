...
from strategies.first_hour_trend import FirstHourTrend
from constants import TransactionSide

N_DAYS = 5
TIME_SPAN = 30
BASE_PATH = os.path.join("data", "zerodha_h1")
OUTPUT_BASE_PATH = os.path.join("output", f"first_hour_trend")
...
def run_for_symbol(file_name):
    ...
    strategy = FirstHourTrend(symbol=symbol_name, n_days=N_DAYS, data=data)
